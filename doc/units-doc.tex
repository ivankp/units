...
The \lstinline{@Nunits@} library can help with this problem.
...
Using the \lstinline{@Nunits@} library, we can avoid these questions and use consistent definitions.
%
\begin{lstlisting}
...
The library uses its definition of pounds to provide the right mass quantity.
